...
describe('Transaction', () => {
  ...
  describe('OutputMap', () => {
    ...
    it('should have recipients balance at the output', () => {
  ...
  describe('Validate transaction', () => {
    ...
    describe('when a transaction is invalid', () => {
      describe('and the transaction outputMap have an invalid value ', () => {
  ...
  describe('Update transaction', () => {
    ...
    describe('and the amount is valid', () => {
      ...
      it('should withdraw the amount from the original sender balance', () => {
        expect(transaction.outputMap[sender.publicKey]).toEqual(
  ...
  describe('Transaction reward', () => {
    ...
    it('should create a reward transaction to the address of the miner', () => {
